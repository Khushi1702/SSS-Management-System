...
<head>
    ...
    <style>
        ...
        .slideshow-container {
            ...
            border-radius: 15px;
            margin-top: 160px;
            /* Adjusted for space below logos */
        }
...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        ...
        <img src="firstpic.png" style="width:100%">
        <div class="text"><b>                    </b></div>
      </div>
      
      <div class="mySlides fade">
        <div class="numbertext">2 / 4</div>
        <img src="secondpic.jpg" style="width:100%">
        <div class="text"><b>                    </b></div>
      </div>
      
      <div class="mySlides fade">
        <div class="numbertext">3 / 4</div>
        <img src="fourthpic.jpg" style="width:100%">
        <div class="text"><b>                    </b></div>
      </div>
       
      <div class="mySlides fade">
        <div class="numbertext">4 / 4</div>
        <a class="nav-link" href="second.php"><img src="thirdpic.jpg" style="width:100%">
      </div>
